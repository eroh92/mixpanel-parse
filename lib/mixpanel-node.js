...
var querystring = {}
try {
querystring.stringify = require('cloud/querystring.encode.js')
} catch(e) {
  querystring.stringify = require('querystring').stringify
}
...
var create_client = function(token, config) {
    ...
    */
    metrics.send_request = function(endpoint, data, callback) {
        ...
        request_options.url = ["http://api.mixpanel.com",endpoint,"?",query].join("");
